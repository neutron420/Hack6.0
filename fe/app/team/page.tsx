  ...
  const teamMembers = [
    {
      ...
      img: "/members/member1.jpg", // from public/members/
    ...
    },
    {
      ...
      img: "/members/member2.jpg", // from public/members/
    ...
    },
    {
      ...
      img: "/members/member3.jpg", // from public/members/
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <Image
                ...
                width={128}
                height={128}
                className="rounded-full object-cover border-4 border-gray-200 mx-auto mb-5"
              />
